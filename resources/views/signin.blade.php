...
<div class="signin">
  <div class="left-signup">
    <img width={100} height={100} src="./imgs/signin_cover.jpg" draggable={false} alt="cover" class="cover" />
    <div class="content">
      <h1>Get started with SE Project</h1>
      <p>Sign in to start using SE Project and get access to all the features.</p>
    </div>
  </div>
  <div class="right-signup">
    <form method="POST" action="{{ route('signin.post') }}">
      ...
      <label>No account yet? <a class="link" href="{{ route('signup') }}">Sign up</a></label>
    </form>
  </div>
</div>
@endsection